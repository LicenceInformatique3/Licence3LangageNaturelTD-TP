...
class ArffPrinter(common.AbstractPrinter):
    ...
    def __init__(self, ctxinfo, category, relation_name="MWETOOLKIT_RELATION", **kwargs):
        super(ArffPrinter, self).__init__(ctxinfo, category, **kwargs)
    ...
    def handle_meta(self, meta, ctxinfo):
        ...
        """
        self.add_string(ctxinfo, "@relation {}\n".format(self.relation_name))
        for meta_feat in meta.meta_feats:
            self.add_string(ctxinfo, "@attribute {} {}\n".format(
    ...
    def handle_candidate(self, candidate, ctxinfo):
        ...
        self.add_string(ctxinfo, ",".join(line), "\n")
